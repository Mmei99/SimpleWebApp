...
<script>
document.getElementById("result").innerHTML=localStorage.getItem("plan");
         ...
         <tr style="border: 3px solid black;">
            ...
            <tbody>
          		 <tr > 
                    ...
                    <td id="surname" > <%=request.getAttribute("surname")%>  </td>
                    <td id="gender" > <%=request.getAttribute("gender")%>  </td>
                    <td id="date" > <%=request.getAttribute("date")%>  </td>
                    <td id="workaddress" > <%=request.getAttribute("workaddress")%>  </td>
                    <td id="homeaddress" > <%=request.getAttribute("homeaddress")%>  </td>
